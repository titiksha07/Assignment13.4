...
export class CricketerComponent implements OnInit {
  ...
  constructor(private _cricketService: CricketerService, private _cricketerDropDown: CriketerDropDownService, private _router: Router) { }
...
canDeactivate(){
  ...
  {
   return window.confirm("Are you sure you do not want to save the data?");
